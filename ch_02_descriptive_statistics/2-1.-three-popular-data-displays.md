...
## 7. Contingency Table \(Cross table\)

Ex. Using `exa2_2` data set, Find the table of each one.
...
# 1. Frequency table of the 2nd Column
x21 <- table(x[[2]])  ; x21      #  or table(x$입학전형)
x22 <- prop.table(x1) ; round(x22,2)      #  or table(x$입학전형)
x23 <- addmargins(x2) ; round(x23,2)

# 2. Frequency table of the 3rd column
x31 <- table(x[[3]])   ; x31   #  or table(x$참여활동)
x32 <- prop.table(x31) ; round(x32,2)    #  or table(x$참여활동)
x33 <- addmargins(x32) ; round(x33,2)

# 3. Contingency table of the 2nd and the 3rd Columns
x41 <- table(x[[2]], x[[3]]) ; x41
