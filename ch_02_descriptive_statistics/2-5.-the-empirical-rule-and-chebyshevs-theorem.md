...
![Relative Frequency Histogram of Heights of Adult Men](../.gitbook/assets/image%20%28146%29.png)
...
![The Empirical Rule](../.gitbook/assets/image%20%28162%29.png)
...
{% tab title="R Code" %}
```text
mean <- 69.6std <- 1.4x <- (68.2, 71)z <- (x - mean) / std
```
{% endtab %}
...
{% tab title="R Code" %}
```text
mean <- 69.6std <- 1.4z <- 2x1 <- mean + z * std; x1x2 <- mean - z * std; x2
```
{% endtab %}

{% tab title="Result b\)" %}
```text
> x1 <- mean + z * std; x1## [1] 72.4> x2 <- mean - z * std; x2## [1] 66.8
```
{% endtab %}
{% endtabs %}
...
{% tab title="R Code" %}
```text
mean <- 100std <- 10x <- c(110, 120, 130)z <- (x - mean) / std ; z
```
{% endtab %}

{% tab title="z-scores" %}
```text
> z <- (x - mean) / std ; z## [1] 1 2 3
```
{% endtab %}
{% endtabs %}

![Distribution of IQ Scores](../.gitbook/assets/image%20%28131%29.png)
...
![A visual illustration of Chebchev&apos;s Theorem](../.gitbook/assets/image%20%2898%29.png)
...
{% tab title="R Code" %}
```text
mean <- 28std <- 3x <- c(22, 34)z <- (x - mean) / std ; z
```
{% endtab %}

{% tab title="z-score" %}
```text
> z <- (x - mean) / std ; z## [1] -2  2
```
{% endtab %}
{% endtabs %}
...
{% tab title="R Code" %}
```text
mean <- 725std <- 25x <- c(675, 775)z <- (x - mean) / std ; z
```
{% endtab %}
