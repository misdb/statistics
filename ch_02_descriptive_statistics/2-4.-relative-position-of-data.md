...
**Example 12.** 다음의의 데이터 세트에 대하여 1.39의 percentile을 구하라. 3.33의 percentile도 구하라.
...
**Example 15.** Example 14의 five-numbers를 구하라.
...
**EXAMPLE 16.** Example 13\)의 Box Plot을 작성하라. 그리고 IQR을를 구하라.
...
**Example 17.** 다음과 같은 10명의 학생의 평균 평점에 대하여 z-score를 구하라.
...
**Example 18.**  최근에 등록했던 학생들 평균 평점의 평균과 표준편차가 각각 $$\mu = 2.70$$과 $$\sigma = 0.50$$ 이었다. Antonio와 Beatrice 두 학생의 z-score는 각각 -0.62와 1.28이었다. 그들의 평균 평점은 몇 점인가?
...
**Example 19.**  Box plot of Example 12.
...
**Example 20.**  Horizontal Box Plot
...
**Example 21.** \(Two Factor Box plot\) 다음의 두 개의 데이터 세트를 하나의 Box-plot으로 표시하라.
...
**Example 22.** 다음의 데이터 세트에서 이상치\(outlier\)를 찾아내라.
