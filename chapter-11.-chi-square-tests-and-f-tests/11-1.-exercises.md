...
**Ex 1.** Find $$χ_{0.01}^2$$ for each of the following number of degrees of freedom.

1. $$df=5$$ 
2. $$df=11$$ 
3. $$df=25$$ 

**Ex 2.** Find $$χ_{0.05}^2$$ for each of the following number of degrees of freedom.

1. $$df=6$$ 
2. $$df=12$$ 
3. $$df=30$$ 

**Ex 3.** Find $$χ_{0.10}^2$$ for each of the following number of degrees of freedom.

1. $$df=6$$ 
2. $$df=12$$ 
3. $$df=30$$ 

**Ex 4.** Find $$χ_{0.01}^2$$ for each of the following number of degrees of freedom.

1. $$df=7$$ 
2. $$df=10$$ 
3. $$df=20$$ 

**Ex 5.** For $$df=7$$ and $$α=0.05$$ , find

1. $$χ^2_α$$ 
2. $$χ^2_{α/2}$$ 

**Ex 6.** For $$df=17$$ and $$α=0.01$$ , find
...
**Ex 9.** A child psychologist believes that children perform better on tests when they are given perceived freedom of choice. To test this belief, the psychologist carried out an experiment in which 200 third graders were randomly assigned to two groups, _A_ and _B_. Each child was given the same simple logic test. However in group _B_, each child was given the freedom to choose a text booklet from many with various drawings on the covers. The performance of each child was rated as Very Good, Good, and Fair. The results are summarized in the table provided. Test, at the 5% level of significance, whether there is sufficient evidence in the data to support the psychologist’s belief.
