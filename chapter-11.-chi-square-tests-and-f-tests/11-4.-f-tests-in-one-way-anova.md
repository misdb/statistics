...
* Step 1. The test of hypotheses isH0 vs.  Ha::μ1=μ2=μ3=μ4 not all four population means are equal  @ α=0.05H0:μ1=μ2=μ3=μ4 vs.  Ha: not all four population means are equal  @ α=0.05
* Step 2. The test statistic is F=MST∕MSEF=MST∕MSE with \(since _n_ = 44 and _K_ = 4\) degrees of freedom df1=K−1=4−1=3df1=K−1=4−1=3 and df2=n−K=44−4=40.df2=n−K=44−4=40.
* Step 3. If we index the population of mathematics majors by 1, English majors by 2, education majors by 3, and biology majors by 4, then the sample sizes, sample means, and sample variances of the four samples in [Table 11.17 "Difficulty Levels of College Majors"](https://saylordotorg.github.io/text_introductory-statistics/s15-04-f-tests-in-one-way-anova.html#fwk-shafer-ch11_s04_t01) are summarized \(after rounding for simplicity\) by:
  ...
  | :--- | :--- | :--- | :--- |
  | Mathematics | n1=11n1=11 | x−−1=2.90x-1=2.90 | s21=0.188s12=0.188 |
  | English | n2=11n2=11 | x−−2=3.34x-2=3.34 | s22=0.148s22=0.148 |
  | Education | n3=11n3=11 | x−−3=3.36x-3=3.36 | s23=0.229s32=0.229 |
  | Biology | n4=11n4=11 | x−−4=3.02x-4=3.02 | s24=0.157s42=0.157 |

  The average of all 44 observations is \(after rounding for simplicity\) x−−=3.15.x-=3.15. We compute \(rounding for simplicity\)MST=11\(2.90−3.15\)2+11\(3.34−3.15\)2+11\(3.36−3.15\)2+11\(3.02−3.15\)24−1=1.75563=0.585MST=11\(2.90−3.15\)2+11\(3.34−3.15\)2+11\(3.36−3.15\)2+11\(3.02−3.15\)24−1=1.75563=0.585

  andMSE===\(11−1\)\(0.188\)+\(11−1\)\(0.148\)+\(11−1\)\(0.229\)+\(11−1\)\(0.157\)44−47.22400.181MSE=\(11−1\)\(0.188\)+\(11−1\)\(0.148\)+\(11−1\)\(0.229\)+\(11−1\)\(0.157\)44−4=7.2240=0.181

  so thatF=MSTMSE=0.5850.181=3.232F=MSTMSE=0.5850.181=3.232

* Step 4. The test is right-tailed. The single critical value is \(since df1=3df1=3 and df2=40df2=40\) Fα=F0.05=2.84.Fα=F0.05=2.84. Thus the rejection region is \[2.84,∞\)\[2.84,∞\), as illustrated in [Figure 11.12](https://saylordotorg.github.io/text_introductory-statistics/s15-04-f-tests-in-one-way-anova.html#fwk-shafer-ch11_s04_f01).
...
* Step 5. Since F=3.232&gt;2.84F=3.232&gt;2.84, we reject _H_0. The data provide sufficient evidence, at the 5% level of significance, to conclude that the averages of major GPAs for the four majors considered are not all equal.
...
* Step 1. The test of hypotheses isH0 vs.  Ha::μ1=μ2=μ3not all three population means are equal  @ α=0.01H0:μ1=μ2=μ3 vs.  Ha:not all three population means are equal  @ α=0.01
* Step 2. The test statistic is F=MST∕MSEF=MST∕MSE with \(since _n_ = 33 and _K_ = 3\) degrees of freedom df1=K−1=3−1=2df1=K−1=3−1=2 and df2=n−K=33−3=30.df2=n−K=33−3=30.
* Step 3. If we index the population of mice receiving Treatment 1 by 1, Treatment 2 by 2, and no treatment by 3, then the sample sizes, sample means, and sample variances of the three samples in [Table 11.18 "Mice Survival Times in Days"](https://saylordotorg.github.io/text_introductory-statistics/s15-04-f-tests-in-one-way-anova.html#fwk-shafer-ch11_s04_t02) are summarized \(after rounding for simplicity\) by:
  ...
  | :--- | :--- | :--- | :--- |
  | Treatment 1 | n1=16n1=16 | x−−1=69.75x-1=69.75 | s21=34.47s12=34.47 |
  | Treatment 2 | n2=9n2=9 | x−−2=77.78x-2=77.78 | s22=52.69s22=52.69 |
  | Control | n3=8n3=8 | x−−3=75.88x-3=75.88 | s23=30.69s32=30.69 |

  The average of all 33 observations is \(after rounding for simplicity\) x−−=73.42.x-=73.42. We compute \(rounding for simplicity\)MST=16\(69.75−73.42\)2+9\(77.78−73.42\)2+8\(75.88−73.42\)23−1=434.632=217.50MST=16\(69.75−73.42\)2+9\(77.78−73.42\)2+8\(75.88−73.42\)23−1=434.632=217.50

  andMSE=\(16−1\)\(34.47\)+\(9−1\)\(52.69\)+\(8−1\)\(30.69\)33−3=1153.430=38.45MSE=\(16−1\)\(34.47\)+\(9−1\)\(52.69\)+\(8−1\)\(30.69\)33−3=1153.430=38.45

  so thatF=MSTMSE=217.5038.45=5.65F=MSTMSE=217.5038.45=5.65

* Step 4. The test is right-tailed. The single critical value is Fα=F0.01=5.39.Fα=F0.01=5.39. Thus the rejection region is \[5.39,∞\)\[5.39,∞\), as illustrated in [Figure 11.13](https://saylordotorg.github.io/text_introductory-statistics/s15-04-f-tests-in-one-way-anova.html#fwk-shafer-ch11_s04_f02).
...
* Step 5. Since F=5.65&gt;5.39F=5.65&gt;5.39, we reject _H_0. The data provide sufficient evidence, at the 1% level of significance, to conclude that a treatment effect exists at least for one of the two treatments in increasing the mean survival time of mice with thymic leukemia.
