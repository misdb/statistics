...
{% tab title="R Source" %}
```text
library(Rstat)df_1 <- 5df_2 <- 4pv <- c(0.90, 0.05)f.quant(df_1, df_2, pv)
```
{% endtab %}

{% tab title="Result" %}
```text
> f.quant(df_1, df_2, pv)##   0.9   0.05 ## 4.0506 0.1926 
```
...
{% tab title="R Source" %}
```text
library(Rstat)df_1 <- 2df_2 <- 20pv <- c(0.95, 0.975, 0.05, 0.025)f.quant(df_1, df_2, pv)
```
{% endtab %}

{% tab title="Result" %}
```text
> f.quant(df_1, df_2, pv)##   0.95  0.975   0.05  0.025 ## 3.4928 4.4613 0.0514 0.0253 
```
...
{% tab title="R Source" %}
```text
library(Rstat)df_1 <- 13df_2 <- 8alpha <- 0.01pv <- c(1-alpha)f.quant(df_1, df_2, pv)pv_1 <- c(alpha)f.quant(df_2, df_1, pv_1)
```
{% endtab %}

{% tab title="Result" %}
```text
> pv <- c(1-alpha)> f.quant(df_1, df_2, pv)##   0.99 ## 5.6089 > pv_1 <- c(alpha)> f.quant(df_2, df_1, pv_1) ##   0.01 ## 0.1783 
```
...
{% tab title="R Source" %}
```text
library(Rstat)df_1 <- 40df_2 <- 10alpha <- 0.975pv <- c(1-alpha)f.quant(df_1, df_2, pv)pv_1 <- c(alpha)f.quant(df_2, df_1, pv_1)
```
{% endtab %}

{% tab title="Result" %}
```text
> pv <- c(1-alpha)> f.quant(df_1, df_2, pv)##  0.025 ## 0.4187 > pv_1 <- c(alpha)> f.quant(df_2, df_1, pv_1)##  0.975 ## 2.3882 
```
