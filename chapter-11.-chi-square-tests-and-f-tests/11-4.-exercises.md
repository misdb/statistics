...
1. The following three random samples are taken from three normal populations with respective means μ1μ1, μ2μ2, and μ3μ3, and the same variance σ2.σ2.
...
2. The following three random samples are taken from three normal populations with respective means μ1μ1, μ2μ2, and μ3μ3, and a same variance σ2.σ2.
