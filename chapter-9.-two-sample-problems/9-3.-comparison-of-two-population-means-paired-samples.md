...
* Step 1. Since the differences were computed in the order  Type 1 mpg− Type 2 mpg Type 1 mpg− Type 2 mpg, better fuel economy with Type 1 fuel corresponds to μd=μ1−μ2&gt;0.μd=μ1−μ2&gt;0. Thus the test isH0:μd vs. Ha:μd=&gt;00@ α=0.05H0:μd=0 vs. Ha:μd&gt;0@ α=0.05

  \(If the differences had been computed in the opposite order then the alternative hypotheses would have been Ha:μd&lt;0.Ha:μd&lt;0.\)

* Step 2. Since the sampling is in pairs the test statistic isT=d−−−D0sd/n−−√T=d-−D0sd∕n
* Step 3. We have already computed d−−d- and _sd_ in the previous example. Inserting their values and D0=0D0=0 into the formula for the test statistic givesT=d−−−D0sd/n−−√=0.14–0.16–/3=2.600T=d-−D0sd∕n=0.14-0.16-∕3=2.600
* Step 4. Since the symbol in _Ha_ is “&gt;” this is a right-tailed test, so there is a single critical value, tα=t0.05tα=t0.05 with 8 degrees of freedom, which from the row labeled df=8df=8 in [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) we read off as 1.860. The rejection region is \[1.860,∞\).\[1.860,∞\).
* Step 5. As shown in [Figure 9.5 "Rejection Region and Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s13-03-comparison-of-two-population-m.html#fwk-shafer-ch09_s03_s02_f01) the test statistic falls in the rejection region. The decision is to reject _H_0. In the context of the problem our conclusion is:

  Figure 9.5Rejection Region and Test Statistic for [Note 9.20 "Example 8"](https://saylordotorg.github.io/text_introductory-statistics/s13-03-comparison-of-two-population-m.html#fwk-shafer-ch09_s03_s02_n02)
