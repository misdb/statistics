...
* Step 4. The observed significance or _p_-value of the test is the area of the right tail of the standard normal distribution that is cut off by the test statistic $$Z = 5.684.$$ The number 5.684 is too large to appear in [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html), which means that the area of the _left_ tail that it cuts off is 1.0000 to four decimal places. The area that we seek, the area of the _right_ tail, is therefore $$(1−1.0000)=0.0000$$ to four decimal places. See [Figure 9.3](https://saylordotorg.github.io/text_introductory-statistics/s13-01-comparison-of-two-population-m.html#fwk-shafer-ch09_s01_s02_f02). That is, $$p -value=0.0000$$ to four decimal places. \(The actual value is approximately $$0.000 000 007.$$ \)

Figure 9.3  _P_-Value for [Note 9.7 "Example 3"](https://saylordotorg.github.io/text_introductory-statistics/s13-01-comparison-of-two-population-m.html#fwk-shafer-ch09_s01_s02_n03)
