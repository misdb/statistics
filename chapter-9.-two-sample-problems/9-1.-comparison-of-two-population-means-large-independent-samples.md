...
**EXAMPLE 2.**   Refer to [Note 9.4 "Example 1"](https://saylordotorg.github.io/text_introductory-statistics/s13-two-sample-problems.html#fwk-shafer-ch09_s01_s01_n02) concerning the mean satisfaction levels of customers of two competing cable television companies. Test at the 1% level of significance whether the data provide sufficient evidence to conclude that Company 1 has a higher mean satisfaction rating than does Company 2. Use the critical value approach.
...
* **Step 2**. Since the samples are independent and both are large the **test statistic** is                                                       $$Z = \frac {(\bar{x_1}-\bar{x_2}) -D_0}  { \sqrt { \frac{s_1^2}{n_1} + \frac{s_2^2}{n_2}  }}$$
...
**EXAMPLE 3.** Perform the test of [Note 9.6 "Example 2"](https://saylordotorg.github.io/text_introductory-statistics/s13-two-sample-problems.html#fwk-shafer-ch09_s01_s02_n02) using the _p_-value approach.

**\[ Solution \]**

The first three steps are identical to those in [Note 9.6 "Example 2"](https://saylordotorg.github.io/text_introductory-statistics/s13-01-comparison-of-two-population-m.html#fwk-shafer-ch09_s01_s02_n02).

* Step 4. The observed significance or _p_-value of the test is the area of the right tail of the standard normal distribution that is cut off by the test statistic _Z_ = 5.684. The number 5.684 is too large to appear in [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html), which means that the area of the _left_ tail that it cuts off is 1.0000 to four decimal places. The area that we seek, the area of the _right_ tail, is therefore 1−1.0000=0.00001−1.0000=0.0000 to four decimal places. See [Figure 9.3](https://saylordotorg.github.io/text_introductory-statistics/s13-01-comparison-of-two-population-m.html#fwk-shafer-ch09_s01_s02_f02). That is, p -value=0.0000p -value=0.0000 to four decimal places. \(The actual value is approximately 0.000 000 007.0.000 000 007.\)

Figure 9.3_P_-Value for [Note 9.7 "Example 3"](https://saylordotorg.github.io/text_introductory-statistics/s13-01-comparison-of-two-population-m.html#fwk-shafer-ch09_s01_s02_n03)

![](https://saylordotorg.github.io/text_introductory-statistics/section_13/dd649c00a430c1f005660c9ed8188d58.jpg)

* Step 5. Since 0.0000 &lt; 0.01, p -value&lt;αp -value&lt;α so the decision is to reject the null hypothesis:
