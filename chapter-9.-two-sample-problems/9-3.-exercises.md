...
**Ex 2.** Use the following paired sample data for this exercise  
...
**Ex 3.** Use the following paired sample data for this exercise.  
...
**Ex 4.** Use the following paired sample data for this exercise.  
...
**Ex 5.** Use the following paired sample data for this exercise.  
...
**Ex 14.** Consider the previous problem again. Since the data set is so large, it is reasonable to use the standard normal distribution instead of Student’s _t_-distribution with 74 degrees of freedom.
