...
**Ex 1.** Construct the confidence interval for $$(p_1−p_2)$$ for the level of confidence and the data given. \(The samples are sufficiently large.\)
...
**Ex 2.** Construct the confidence interval for $$(p_1−p_2)$$ for the level of confidence and the data given. \(The samples are sufficiently large.\)
...
**Ex 3.** Construct the confidence interval for $$(p_1−p_2)$$ for the level of confidence and the data given. \(The samples are sufficiently large.\)
...
**Ex 4.** Construct the confidence interval for $$(p_1−p_2)$$ for the level of confidence and the data given. \(The samples are sufficiently large.\)
...
**Ex 5.** Perform the test of hypotheses indicated, using the data given. Use the critical value approach. Compute the _p_-value of the test as well. \(The samples are sufficiently large.\)
...
**Ex 6.** Perform the test of hypotheses indicated, using the data given. Use the critical value approach. Compute the _p_-value of the test as well. \(The samples are sufficiently large.\)
...
**Ex 7.** Perform the test of hypotheses indicated, using the data given. Use the critical value approach. Compute the _p_-value of the test as well. \(The samples are sufficiently large.\)
...
**Ex 8.** Perform the test of hypotheses indicated, using the data given. Use the critical value approach. Compute the _p_-value of the test as well. \(The samples are sufficiently large.\)
...
**Ex 9.** Perform the test of hypotheses indicated, using the data given. Use the _p_-value approach. \(The samples are sufficiently large.\)
...
**Ex 10.** Perform the test of hypotheses indicated, using the data given. Use the _p_-value approach. \(The samples are sufficiently large.\)
...
**Ex 11.** Perform the test of hypotheses indicated, using the data given. Use the _p_-value approach. \(The samples are sufficiently large.\)
...
**Ex 12.** Perform the test of hypotheses indicated, using the data given. Use the _p_-value approach. \(The samples are sufficiently large.\)
...
**Ex 19.** Large **Data Sets 6A and 6B** record results of a random survey of 200 voters in each of two regions, in which they were asked to express whether they prefer Candidate _A_ for a U.S. Senate seat or prefer some other candidate. Let the population of all voters in region 1 be denoted Population 1 and the population of all voters in region 2 be denoted Population 2. Let $$p_1$$ be the proportion of voters in Population 1 who prefer Candidate _A_, and $$p_2$$ the proportion in Population 2 who do.
