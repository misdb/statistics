...
The point estimate of p1−p2p1−p2 ispˆ1−pˆ2=0.67−0.80=−0.13p^1−p^2=0.67−0.80=−0.13
...
The sample sizes are sufficiently large for constructing a confidence interval since for sample 1:3 pˆ1\(1−pˆ1\)n1−−−−−−−−−−√=3 \(0.67\)\(0.33\)500−−−−−−−−−−−√=0.063 p^1\(1−p^1\)n1=3 \(0.67\)\(0.33\)500=0.06

so that\[pˆ1−3 pˆ1\(1−pˆ1\)n1−−−−−−√, pˆ1+3 pˆ1\(1−pˆ1\)n1−−−−−−√\]=\[0.67−0.06,0.67+0.06 \]=\[0.61,0.73 \]⊂\[0,1 \]p^1−3 p^1\(1−p^1\)n1, p^1+3 p^1\(1−p^1\)n1=\[0.67−0.06,0.67+0.06 \]=\[0.61,0.73 \]⊂\[0,1 \]

and for sample 2:3 pˆ1\(1−pˆ1\)n1−−−−−−−−−−√=3 \(0.8\)\(0.2\)100−−−−−−−−−√=0.123 p^1\(1−p^1\)n1=3 \(0.8\)\(0.2\)100=0.12

so that\[pˆ2−3 pˆ2\(1−pˆ2\)n2−−−−−−√, pˆ2+3 pˆ2\(1−pˆ2\)n2−−−−−−√\]=\[0.8−0.12,0.8+0.12 \]=\[0.68,0.92 \]⊂\[0,1 \]p^2−3 p^2\(1−p^2\)n2, p^2+3 p^2\(1−p^2\)n2=\[0.8−0.12,0.8+0.12 \]=\[0.68,0.92 \]⊂\[0,1 \]

To apply the formula for the confidence interval, we first observe that the 90% confidence level means that α=1−0.90=0.10α=1−0.90=0.10 so that zα∕2=z0.05.zα∕2=z0.05. From [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) we read directly that z0.05=1.645.z0.05=1.645. Thus the desired confidence interval is\(pˆ1−pˆ2\)±==zα∕2pˆ1\(1−pˆ1\)n1+pˆ2\(1−pˆ2\)n2−−−−−−−−−−−−−−√−0.13±1.645\(0.67\)\(0.33\)500+\(0.8\)\(0.2\)100−−−−−−−−−−−−−−−−√ −0.13±0.07 \(p^1−p^2\)±zα∕2p^1\(1−p^1\)n1+p^2\(1−p^2\)n2=−0.13±1.645\(0.67\)\(0.33\)500+\(0.8\)\(0.2\)100 =−0.13±0.07 
...
* Step 1. Taking into account the labeling of the populations an increase in passing rate at the first inspection by more than 5 percentage points after public access on the web may be expressed as p2&gt;p1+0.05p2&gt;p1+0.05, which by algebra is the same as p1−p2&lt;−0.05.p1−p2&lt;−0.05. This is the alternative hypothesis. Since the null hypothesis is always expressed as an equality, with the same number on the right as is in the alternative hypothesis, the test isH0:p1−p2  vs. Ha:p1−p2=&lt;−0.05−0.05@  α=0.10H0:p1−p2=−0.05  vs. Ha:p1−p2&lt;−0.05@  α=0.10
* Step 2. Since the test is with respect to a difference in population proportions the test statistic isZ=\(pˆ1−pˆ2\)−D0pˆ1\(1−pˆ1\)n1+pˆ2\(1−pˆ2\)n2−−−−−−−−−−−−−−−√Z=\(p^1−p^2\)−D0p^1\(1−p^1\)n1+p^2\(1−p^2\)n2
* Step 3. Inserting the values given in [Note 9.25 "Example 10"](https://saylordotorg.github.io/text_introductory-statistics/s13-04-comparison-of-two-population-p.html#fwk-shafer-ch09_s04_s01_n02) and the value D0=−0.05D0=−0.05 into the formula for the test statistic givesZ=\(pˆ1−pˆ2\)−D0pˆ1\(1−pˆ1\)n1+pˆ2\(1−pˆ2\)n2−−−−−−−−−−−−−−−√=\(−0.13\)−\(−0.05\)\(0.67\)\(0.33\)500+\(0.8\)\(0.2\)100−−−−−−−−−−−−−−−√=−1.770Z=\(p^1−p^2\)−D0p^1\(1−p^1\)n1+p^2\(1−p^2\)n2=\(−0.13\)−\(−0.05\)\(0.67\)\(0.33\)500+\(0.8\)\(0.2\)100=−1.770
* Step 4. Since the symbol in _Ha_ is “&lt;” this is a left-tailed test, so there is a single critical value, zα=−z0.10.zα=−z0.10. From the last row in [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) z0.10=1.282z0.10=1.282, so −z0.10=−1.282.−z0.10=−1.282. The rejection region is \(−∞,−1.282 \].\(−∞,−1.282 \].
* Step 5. As shown in [Figure 9.8 "Rejection Region and Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s13-04-comparison-of-two-population-p.html#fwk-shafer-ch09_s04_s02_f01) the test statistic falls in the rejection region. The decision is to reject _H_0. In the context of the problem our conclusion is:
...
Figure 9.8Rejection Region and Test Statistic for [Note 9.27 "Example 11"](https://saylordotorg.github.io/text_introductory-statistics/s13-04-comparison-of-two-population-p.html#fwk-shafer-ch09_s04_s02_n02)

![](https://saylordotorg.github.io/text_introductory-statistics/section_13/22ebc3b67649345e707b089c29451d59.jpg)



**EXAMPLE 12.** Perform the test of [Note 9.27 "Example 11"](https://saylordotorg.github.io/text_introductory-statistics/s13-two-sample-problems.html#fwk-shafer-ch09_s04_s02_n02) using the _p_-value approach.

**\[ Solution \]**

* Step 4. Because the test is left-tailed the observed significance or _p_-value of the test is just the area of the left tail of the standard normal distribution that is cut off by the test statistic Z=−1.770.Z=−1.770. From [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) the area of the left tail determined by −1.77 is 0.0384. The _p_-value is 0.0384.
* Step 5. Since the _p_-value 0.0384 is less than α=0.10α=0.10, the decision is to reject the null hypothesis: The data provide sufficient evidence, at the 10% level of significance, to conclude that the rate of passing on the first inspection has increased by more than 5 percentage points since records were publicly posted on the web.
