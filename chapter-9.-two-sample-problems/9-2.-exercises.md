...
**Ex 5.** Construct the confidence interval for $$(μ_1−μ_2)$$ for the level of confidence and the data from independent samples given.
...
**Ex 10.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach. \(The _p_-value can be only approximated.\)
...
**Ex 11.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach. \(The _p_-value can be only approximated.\)
...
**Ex 12.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach. \(The _p_-value can be only approximated.\)
...
**Ex 13.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach. \(The _p_-value can be only approximated.\)
