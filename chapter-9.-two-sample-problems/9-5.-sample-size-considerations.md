...
The numbers $$s_1 $$ and $$s_2$$ are estimates of the standard deviations $$σ_1$$ and $$σ_2$$ of the two populations. In analogy with what we did in [Section 7.4 "Sample Size Considerations"](https://saylordotorg.github.io/text_introductory-statistics/fwk-shafer-ch07_s04#fwk-shafer-ch07_s04) in [Chapter 7 "Estimation"](https://saylordotorg.github.io/text_introductory-statistics/s11-estimation.html) we will assume that we either know or can reasonably approximate $$σ_1$$ and $$σ_2$$.
...
Confidence level 99.5% means that $$α=(1−0.995)=0.005$$ so $$α∕2=0.0025.$$ From the last line of [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) we obtain $$z_{0.0025}=2.807.$$ 
...
Confidence level 99.9% means that $$α=(1−0.999)=0.001$$ so $$α∕2=0.0005$$ . From the last line of [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) we obtain $$z_{0.0005}=3.291$$ .
