...
**Ex 5.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the critical value approach. Compute the _p_-value of the test as well.
...
**Ex 6.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the critical value approach. Compute the _p_-value of the test as well.
...
**Ex 7.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the critical value approach. Compute the _p_-value of the test as well.
...
**Ex 8.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the critical value approach. Compute the _p_-value of the test as well.
...
**Ex 9.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach.
...
**Ex 10.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach.
...
**Ex 11.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach.
...
**Ex 12.** Perform the test of hypotheses indicated, using the data from independent samples given. Use the _p_-value approach.
...
**Ex 19.** Children in two elementary school classrooms were given two versions of the same test, but with the order of questions arranged from easier to more difficult in Version _A_ and in reverse order in Version _B_. Randomly selected students from each class were given Version _A_ and the rest Version _B_. The results are shown in the table.
...
{% file src="../.gitbook/assets/data1a.xls" caption="Data Set 1A" %}

{% file src="../.gitbook/assets/data1b \(1\).xls" caption="Data Set 1B" %}

{% file src="../.gitbook/assets/data7a \(1\).xls" caption="Data Set 7A" %}

{% file src="../.gitbook/assets/data7b \(4\).xls" caption="Data Set 7B" %}

**Ex 25.** Large **Data Sets 1A and 1B** list the SAT scores for 1,000 randomly selected students. Denote the population of all male students as Population 1 and the population of all female students as Population 2.
