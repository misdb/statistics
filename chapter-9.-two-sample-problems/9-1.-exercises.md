...
1. Construct the confidence interval for μ1−μ2μ1−μ2 for the level of confidence and the data from independent samples given.
   1. 90% confidence,

      $$n_1=45, \bar{x_1}=27, s_1=2 ,$$   
      $$n_2=60, \bar{x_1}=22, s_2=3$$

   2. 99% confidence,

      $$n_1=30, \bar{x_1}=-112, s_1=9 ,$$   
      $$n_2=40, \bar{x_1}=-98, s_2=4$$
