...
**EXAMPLE 3.** In the context of [Note 8.9 "Example 2"](https://saylordotorg.github.io/text_introductory-statistics/s12-testing-hypotheses.html#fwk-shafer-ch08_s01_s01_n04), suppose that it is known that the population is normally distributed with standard deviation $$σ = 0.15$$ gram, and suppose that the test of hypotheses $$H_0:μ=8.0$$ versus $$H_a:μ≠8.0$$ will be performed with a sample of size 5. Construct the rejection region for the test for the choice $$α=0.10$$ . Explain the decision procedure and interpret it.
