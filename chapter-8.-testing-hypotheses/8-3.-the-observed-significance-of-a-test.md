...
* **Step 1**. Let _μ_ be the true average total game score of all NBA games.  The relevant test is  $$H0:μ=202.5 vs. Ha:μ<202.5, @ α=0.05$$ 
...
* **Step 3.** Inserting the data into the formula for the test statistic gives                        $$z_c= \frac {(\bar{x} −μ_0)} {s/ \sqrt{n}} = \frac {(199.2 - 202.5)} {19.63 / \sqrt{85}} = -1.55$$
* **Step 4.** The area of the left tail cut off by $$z=−1.55$$ is, by [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html), 0.0606, as illustrated in [Figure 8.8 "Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_f01). Since the test is left-tailed, the _p_-value is just this number, $$p = 0.0606$$ .
...
Figure 8.8Test Statistic for [Note 8.36 "Example 7"](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_n02)
...
* **Step 3.** Inserting the data into the formula for the test statistic gives                   $$z_c= \frac {(\bar{x} −μ_0)} {s/ \sqrt{n}} =\frac {(69.4 −67)} {6.1/ \sqrt{64}} = 3.15 $$
* **Step 4.** The area of the right tail cut off by $$z = 3.15$$ is, by [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html), $$(1−0.9992)=0.0008$$ , as shown in [Figure 8.9 "Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_f02). Since the test is right-tailed, the _p_-value is just this number, $$p = 0.0008$$ .
...
Figure 8.9Test Statistic for [Note 8.37 "Example 8"](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_n03)
...
* **Step 3**. Inserting the data into the formula for the test statistic gives                          $$z_c= \frac {(\bar{x} −μ_0)} {s/ \sqrt{n}} =\frac {(7.7 −7.4)} {0.5/ \sqrt{30}}=3.29$$
* **Step 4.** The area of the right tail cut off by $$z = 3.29$$ is, by [Figure 12.2 "Cumulative Normal Probability"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html), $$(1−0.9995)=0.0005$$ , as illustrated in [Figure 8.10 "Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_f03). Since the test is two-tailed, the _p_-value is the double of this number, $$p=2×0.0005=0.0010$$ .
...
Figure 8.10Test Statistic for [Note 8.38 "Example 9"](https://saylordotorg.github.io/text_introductory-statistics/s12-03-the-observed-significance-of-a.html#fwk-shafer-ch08_s03_s02_n04)
