...
**EXAMPLE 30.**  고장횟수가 포아송 분포를 따르는 어떤 기계는 1개월에 평균 3번 고장이 난다. 이 기계가 고장이 나서 고친 후 2개월 내에는 다시 고장나지 않을 확률을 구하라.

**\[ Solution \]** 

고장날 때까지의 시간을 X개월이라고 하면,  X는 지수분포를 따른다.  1개월에 평균 3번 고장이 나므로, $$\lambda t = (1) (3) = 3$$ 이 된다.
...
## 4. Exponential Distribution and Geometry Distribution
