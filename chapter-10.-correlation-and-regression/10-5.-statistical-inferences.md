...
EXAMPLE 6_._  Construct the 95% confidence interval for the slope $$β_1$$ of the population regression line based on the five-point sample data 
...
**EXAMPLE 8.** Test, at the 2% level of significance, whether the variable _x_ is useful for predicting _y_ based on the information in the five-point data set
...
* Step 1. Since _x_ is useful for prediction of _y_ precisely when the slope β1β1 of the population regression line is nonzero, the relevant test is  H0:β1=0vs. Ha:β1≠0 @ α=0.02  H0:β1=0vs. Ha:β1≠0 @ α=0.02
* Step 2. The test statistic isT=βˆ1sε/SSxx−−−−√T=β^1sε∕SSxx

  and has Student’s _t_-distribution with n−2=5−2=3n−2=5−2=3 degrees of freedom.

* Step 3. From [Note 10.18 "Example 2"](https://saylordotorg.github.io/text_introductory-statistics/fwk-shafer-ch10_s04#fwk-shafer-ch10_s04_s02_n02), βˆ1=0.34375β^1=0.34375 and SSxx=51.2.SSxx=51.2. From [Note 10.30 "Example 6"](https://saylordotorg.github.io/text_introductory-statistics/s14-05-statistical-inferences-about-1.html#fwk-shafer-ch10_s05_s01_n03), sε=0.50.sε=0.50. The value of the test statistic is thereforeT=βˆ1−B0sε/SSxx−−−−√=0.343750.50/51.2−−−−√=4.919T=β^1−B0sε∕SSxx=0.343750.50∕51.2=4.919
* Step 4. Since the symbol in _Ha_ is “≠” this is a two-tailed test, so there are two critical values ±tα∕2=±t0.01.±tα∕2=±t0.01. Reading from the line in [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) labeled df=3df=3, t0.01=4.541.t0.01=4.541. The rejection region is \(−∞,−4.541\]∪\[4.541,∞\).\(−∞,−4.541\]∪\[4.541,∞\).
* Step 5. As shown in [Figure 10.9 "Rejection Region and Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s14-05-statistical-inferences-about-1.html#fwk-shafer-ch10_s05_s02_f01) the test statistic falls in the rejection region. The decision is to reject _H_0. In the context of the problem our conclusion is:

  The data provide sufficient evidence, at the 2% level of significance, to conclude that the slope of the population regression line is nonzero, so that _x_ is useful as a predictor of _y_.
...
* Step 1. In terms of the variables _x_ and _y_, the salesman’s claim is that if _x_ is increased by 1 unit \(one additional year in age\), then _y_ decreases by more than 1.1 units \(more than $1,100\). Thus his assertion is that the slope of the population regression line is negative, and that it is more negative than −1.1. In symbols, β1&lt;−1.1.β1&lt;−1.1. Since it contains an inequality, this has to be the alternative hypotheses. The null hypothesis has to be an equality and have the same number on the right hand side, so the relevant test is  H0:β1=−1.1vs. Hα:β1&lt;−1.1 @ α=0.05  H0:β1=−1.1vs. Hα:β1&lt;−1.1 @ α=0.05
* Step 2. The test statistic isT=βˆ1−B0sε/SSxx−−−−√T=β^1−B0sε∕SSxx

  and has Student’s _t_-distribution with 8 degrees of freedom.

* Step 3. From [Note 10.19 "Example 3"](https://saylordotorg.github.io/text_introductory-statistics/s14-04-the-least-squares-regression-l.html), βˆ1=−2.05β^1=−2.05 and SSxx=14.SSxx=14. From [Note 10.31 "Example 7"](https://saylordotorg.github.io/text_introductory-statistics/s14-05-statistical-inferences-about-1.html#fwk-shafer-ch10_s05_s01_n04), sε=1.902169814.sε=1.902169814. The value of the test statistic is thereforeT=βˆ1−B0sε/SSxx−−−−√=−2.05−\(−1.1\)1.902169814/14−−√=−1.869T=β^1−B0sε∕SSxx=−2.05−\(−1.1\)1.902169814∕14=−1.869
* Step 4. Since the symbol in _Ha_ is “&lt;” this is a left-tailed test, so there is a single critical value −tα=−t0.05.−tα=−t0.05. Reading from the line in [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) labeled df=8df=8, t0.05=1.860.t0.05=1.860. The rejection region is \(−∞,−1.860\].\(−∞,−1.860\].
* Step 5. As shown in [Figure 10.10 "Rejection Region and Test Statistic for "](https://saylordotorg.github.io/text_introductory-statistics/s14-05-statistical-inferences-about-1.html#fwk-shafer-ch10_s05_s02_f02) the test statistic falls in the rejection region. The decision is to reject _H_0. In the context of the problem our conclusion is:
...
Figure 10.10Rejection Region and Test Statistic for [Note 10.34 "Example 9"](https://saylordotorg.github.io/text_introductory-statistics/s14-05-statistical-inferences-about-1.html#fwk-shafer-ch10_s05_s02_n03)![](https://saylordotorg.github.io/text_introductory-statistics/section_14/da0a5676198f1c1c85bdb57bbd79e2b1.jpg)
