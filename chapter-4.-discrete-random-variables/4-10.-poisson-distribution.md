...
$$\Rightarrow P(X=x | X+Y=n) = \frac{\frac{e^{-\lambda_2}\cdot \lambda_2^{n-x}}{(n-x)!} \cdot \frac{e^{-\lambda_1}\cdot \lambda_1^{n-x}}{x!} }{ \frac{e^{-(\lambda_1 + \lambda_2)}\cdot (\lambda_1 + \lambda_2)^n  }{n!} }$$ 
