...
**Ex .** Determine whether or not the random variable $$X$$ is a binomial random variable. If so, give the values of $$ n$$ and $$p$$ . If not, explain why not.
...
**Ex .** $$X$$ is a binomial random variable with parameters $$n = 12$$ and $$p = 0.82$$ . Compute the probability indicated.
...
**Ex .** $$X$$ is a binomial random variable with parameters $$n = 16$$ and $$p = 0.74$$. Compute the probability indicated.
...
**Ex .** $$X$$ is a binomial random variable with parameters $$n = 5$$, $$p = 0.5$$. Use the tables in [Chapter 12 "Appendix"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) to compute the probability indicated.
...
**Ex .** $$X$$ is a binomial random variable with parameters $$n = 5$$, $$p = 0.3$$. Use the table in [Chapter 12 "Appendix"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) to compute the probability indicated.
...
**Ex .** $$X$$ is a binomial random variable with the parameters shown. Compute its mean _μ_ and standard deviation _σ_ in two ways, first using the tables in [Chapter 12 "Appendix"](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) in conjunction with the general formulas   
