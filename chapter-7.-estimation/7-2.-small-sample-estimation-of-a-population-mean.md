...
Confidence level 95% means that $$α=1−0.90=0.10$$ so $$α∕2=0.05$$. Since the sample size is _n_ = 12, there are n−1=11n−1=11 degrees of freedom. By [Figure 12.3 "Critical Values of "](https://saylordotorg.github.io/text_introductory-statistics/s16-appendix.html) t0.05=1.796.t0.05=1.796. Thusx−−±tα∕2⎛⎝sn−−√⎞⎠=2.71±1.796\(0.5112−−√\)=2.71±0.26x-±tα∕2sn=2.71±1.7960.5112=2.71±0.26
